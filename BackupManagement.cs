        ...
        public void OnStopCommand(CCSPlayerController? player, CommandInfo? command)
        {
            ...
            if (isStopCommandAvailable && isMatchLive)
            {
                ...
                else
                {
                    ...
                    Server.PrintToChatAll($" {ChatColors.Green}{stopTeamName}{ChatColors.Default} chcú obnovi zápas na zaèiatok aktuálneho kola. {ChatColors.Green}{remainingStopTeam}{ChatColors.Default}Pre potvrdenie napíš {ChatColors.Green}.stop");
                }
            }
        }
